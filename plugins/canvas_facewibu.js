...
try {
  ...
  let p = await (await fetch('https://tessyy-api.herokuapp.com/canvas/facepalm?url='+encodeURIComponent(url) )).buffer()
  m.reply('_Tunggu Sebentar. . ._')
  conn.sendFile(m.chat, p, 'image.png' , 'uuuyyy mengerikan', m)
  } catch (e) {
