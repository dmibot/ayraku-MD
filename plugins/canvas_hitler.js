...
d = await (await fetch('https://tessyy-api.herokuapp.com/canvas/hitler?url='+encodeURIComponent(c) )).buffer()
  m.reply('_Tunggu Sebentar. . ._')
  conn.sendFile(m.chat, d, 'image.png' , 'Shit Bro!\nternyata dia *Hitler*', m)
 } catch (e) {
